...
date = "2024-09-19"
description = "Introducing my WS2HTTP project: a Rust bridge that converts WebSocket events to HTTP requests, bringing real-time capabilities to CGI backends while maintaining isolation benefits."
