...
## REPL-Driven Development Challenges
...
system is pretty powerful I struggled with keeping the Source code and REPL state in sync. 

Sometimes I forgot to redefine a changed procedure, or got issues with the module system since the load-paths were different
when executing the script from a terminal or via geiser.

## Hot-Reload Approach: A Better Alternative?
...
Oh and this also circumvents the problem of geiser going unresponsive after accidentally executing an infinite loop, which at least once also took Emacs with it
(although this might be due to the SDL2 FFI).

## Lessons for Nujel's Development Environment

All this makes me think about how to handle these in Nujel, and I've come to a couple of conclusions:
