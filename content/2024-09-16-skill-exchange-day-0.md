...
### Initial Impressions of the Stack
...
straight `<p>`/`<h1>` or whatever, I suppose it's necessary for styles, though I'd then prefer separate
...
## Asides: Life in Busan

Had 돼지국밥(Dwaeji gukbap) for lunch today which was really tasty, apparently a Busan specialty and definitely something to try out when you get the chance. Although the food here in general is fantastic, getting some fresh 김밥(Gimbap) for breakfast feels quite luxurious, even though it's pretty cheap.
