...
date = "2025-04-16"
description = "ZZTerm is a new terminal emulator that extends beyond ANSI/VT-100 to support graphical applications with multiple layers, audio, and improved input handling - an alternative to Kitty, Alacritty, and XTerm with a focus on rich interactive applications."

[taxonomies]
tags = ["tech", "projects", "terminal-emulator", "graphics", "developer-tools"]
+++
...
There are some ideas which might be good but I'm currently somewhat hesitant about, I'll list them here to hopefully organize my thougts:
